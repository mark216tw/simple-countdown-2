...
gh release create v1.0.0 path\to\signed-release.apk --title "簡單倒數2 v1.0.0" --notes-file CHANGELOG.md
```

Release 附件應使用清楚名稱，例如 `simple-countdown-2-v1.0.0.apk`，並在說明中標示最低 Android 版本、簽章類型與重要變更。
